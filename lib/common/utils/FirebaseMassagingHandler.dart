...
import 'dart:io';
import 'dart:ui';
import 'package:kittycav/common/apis/apis.dart';
...
import 'package:kittycav/common/values/values.dart';
...
class FirebaseMassagingHandler {
  ...
  const AndroidNotificationChannel(
    'com.example.audio_video_call_flutter_app.call', // id
    'chatty_call', // title
  ...
  const AndroidNotificationChannel(
    'com.example.audio_video_call_flutter_app.message', // id
  ...
  //This basically tells the app, to priritise this function and call it natively, not necessarily in dart code
